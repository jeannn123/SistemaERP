...
-- Productos (catalogo Mamma Tomato)
...
-- Pagos (desglose por boleta; el pedido 3 ejemplifica un pago mixto)
INSERT INTO `pago` (`id_pago`, `monto`, `id_pedido`, `id_metodopago`) VALUES
  (1, 49.80, 1, 1),
  (2, 44.84, 2, 3),
  (3, 30.00, 3, 2),
  (4, 23.10, 3, 1),
